...
public class BillTest {
    ...
    public void setUp() {
        ...
        testProduct2 = new Product("banana", 20.0, 2);
        testProduct3 = new Product("watermelon", 50.5, 3);
        testProduct4 = new Product("apple", 8.5, 4);
...
//
//        assertEquals(expected1, testBill.toString());
//
//    }
