...
public class WorkerTest {
    ...
    public void initData() {
        ...
        worker = new Worker();
        worker.getUsers().add(user1);
        worker.getUsers().add(user2);
        worker.getUsers().add(user3);
        worker.getUsers().add(user4);
        worker.getUsers().add(user5);
        worker.getUsers().add(user6);
        worker.getUsers().add(user7);
    }
